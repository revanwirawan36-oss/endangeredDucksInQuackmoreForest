...
Permainan ini berfungsi sebagai alat uji kognitif dengan dua tingkat kesulitan yang berbeda, dirancang untuk melatih **memori kerja spasial**, **perhitungan prediktif**, dan **fungsi eksekutif** Anda:

### 🌟 Mode Easy (Akses Penuh)

* **Tujuan:** Bebek selalu terlihat, fokus pada **kecepatan reaksi** dan **strategi perburuan** di tengah pergerakan Bebek.
...
### 🎨 Daftar Ikon dan Vektor Pergerakan (6 Varian)
